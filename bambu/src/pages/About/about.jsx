...
const About = () => {
  return (
    <div className=' flex flex-col items-center w-full absolute top-16' style={{backgroundColor:'#F2EDDC'}} >
        <h1 className='font-bold mt-16 text-xl text-green-800' >{texts.tittle1}</h1>
        
        <div className='my-4 mx-4'>

        <h2 className='mx-32 font-semibold text-lg text-green-900'>{texts.tittle2}</h2>
            <div className='flex flex-row'>
                <span className="inline-flex  w-96 flex-col text-justify">
        ...
        <div key='Container equipo'>
            ...
            <div className='flex flex-row'>
                <div className='place-items-center bg-green-500 m-6 w-44 rounded-xl border-8 border-green-800'>
                ...
                <div className='place-items-center bg-green-500 m-6 w-44 rounded-xl border-8 border-green-800'>
                    <div key='container equipo 2' className='ml-4 flex flex-row'>
                        <h1 className=' mt-3 mb-0 font-semibold'>Gabriel Heredia</h1>
                ...
                <Image src={imageGabo} className='w-28 h-28 ml-8 mb-2' alt="" />
                </div>
            </div>
        </div>
