    ...
    <div className="flex flex-col h-full">
      <div className={style.container}>
        <div className=" mx-auto flex items-center justify-end mt-8 mr-20 h-full ">
          <div className=' bg-zinc-300 bg-opacity-70 backdrop-blur-full p-20 w-1/3 rounded-tl-none rounded-tr-full rounded-bl-full rounded-br-none' style={{
            width: '35em',
            // marginLeft: '2em',
      ...
      <div className="flex flex-row mt-20 animated animate__fadeIn">
        <div className="flex-1 text-center m-10 block rounded-lg bg-transparent bg-opacity-50 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
          <div className="p-6">
            <h5 className="mb-2 text-3xl leading-tight text-green-700 font-semibold">
              <i className="fas fa-edit mr-2 text-4xl"></i> Variedad de Recursos Descargables
            </h5>
            <p className="mb-4 mt-10 text-base text-neutral-600 ">
