  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="items-center mt-12 h-96 w-full h-full"
      >
        <h2
          key="Titulo 4"
          style={{ marginLeft: "1em" }}
          className="font-bold mt-28 mb-12 text-4xl text-center md:text-4xl md:text-4xl sm:text-3xl text-green-800"
        >
          {texts.tittle4}
        </h2>
